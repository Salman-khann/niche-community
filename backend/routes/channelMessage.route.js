...
import { getChannelMessages, createChannelMessage, reactToChannelMessage, getChannelMessageComments, addChannelMessageComment, reactToChannelMessageComment, togglePin, getPinnedMessages, searchChannelMessages, deleteChannelMessage, editChannelMessage } from "../controllers/channelMessage.controller.js";

const router = express.Router();

router.get("/:channelId", verifyToken, verifyCommunityAccess, requirePremiumForChannel, getChannelMessages);
router.get("/:channelId/search", verifyToken, verifyCommunityAccess, requirePremiumForChannel, searchChannelMessages);
router.post("/:channelId", verifyToken, verifyCommunityAccess, requirePremiumForChannel, createChannelMessage);
router.put("/:channelId/:messageId", verifyToken, verifyCommunityAccess, requirePremiumForChannel, editChannelMessage);
...
router.delete("/:channelId/:messageId", verifyToken, verifyCommunityAccess, requirePremiumForChannel, deleteChannelMessage);
